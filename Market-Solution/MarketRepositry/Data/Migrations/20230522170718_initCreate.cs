        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferToId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PurchasingVisa = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    PurchasingCash = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    CloseInventory = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    OpenInventory = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Consumption = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Month = table.Column<int>(type: "int", nullable: false),
                    Sales = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodCost", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodCost_Branchs_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branchs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodCost_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Product = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<double>(type: "float", nullable: false),
                    SalesValue = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Vat = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TotalSales = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Average = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Month = table.Column<int>(type: "int", nullable: false),
                    BranchId = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodCost_BranchId",
                table: "FoodCost",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodCost_CategoryId",
                table: "FoodCost",
                column: "CategoryId");
